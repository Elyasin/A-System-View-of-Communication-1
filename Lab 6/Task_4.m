...
for i = 1:num_SPB,
    ...
    eq_wave = equalizer(rx_wave,0.9);
    eq_threshold = get_threshold(eq_wave);
    eq_bs = get_bits(eq_wave, SPB, eq_threshold, start_ind, 1280, 2*SPB-1);
    BER_eq(i) = compute_BER(tx_bs, eq_bs);
